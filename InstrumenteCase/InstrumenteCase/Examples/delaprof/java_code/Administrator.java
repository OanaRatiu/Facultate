...
public class Administrator {
		...
		class ConstraintChecker {
			...
			public void check_precondition(String bCode, String name,
				...
				if (!bAnd) {
					result = false;
					System.err
							.println("precondition 'arguments validation' failed for object "
									+ Administrator.this);
				}
		...
		class ConstraintChecker {
			...
			private void check_precondition(String bCode) {
				...
				if (!bNotEquals) {
					result = false;
					System.err
							.println("precondition 'precondition' failed for object "
									+ Administrator.this);
				}
	...
	private void internal_updateProduct(String barCode, String name, float price) {
		saleSystem.handleUpdateProduct(barCode, new Product(barCode,name,price));
	}
