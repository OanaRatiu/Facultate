...
public class Inspector {
    ...
    public Detinator addDetinator(Detinator detinator) {

        
        class ConstraintChecker {

            
            public Detinator result;
    ...
    public Mormant addMormant(Mormant mormant) {

        
        class ConstraintChecker {

            
            public Mormant result;
    ...
    private Detinator internal_addDetinator(Detinator detinator) {
    	return detinator;
    }
    
    private Mormant internal_addMormant(Mormant mormant) {
    	return mormant;
    }
